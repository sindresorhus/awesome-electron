...
- [electron-gatsby-boilerplate](https://github.com/zonayedpca/electron-gatsby-boilerplate) - Boilerplate to build your app with Gatsby. Create new BrowserWindow as simply as you can do in Gatsby. Supports Redux, Hot Reload, Automatic Deployment and Automatic Linting.
