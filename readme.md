...
- [chromium-net-errors](https://github.com/maxkueng/chromium-net-errors) - All of Chromium's network errors as custom error classes, resolvable by error code and description.
