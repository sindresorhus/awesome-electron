...
- [electron-ipc-plus](https://github.com/electron-utils/electron-ipc-plus) - Improved IPC for Electron.
- [electron-platform](https://github.com/electron-utils/electron-platform) - Platform detection for Electron, Web Browser and Node.
- [electron-quick-inspect](https://github.com/electron-utils/electron-quick-inspect) - Quickly inspect an element at mouse position via `webContents.inspectElement(x,y)`.
