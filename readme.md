...
- [SwarmClaw](https://github.com/swarmclawai/swarmclaw) - Self-hosted multi-agent AI runtime with MCP client and server support, persistent memory, skills, and schedules.
